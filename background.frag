...
#define AA 10	// make this 2 if you are feeling cold...
#define HEIGHT 12.
...
vec3 spunk(vec2 uv)
{
	   vec3 col = vec3(2.55,1.35,1.225);		// Drop Colour
    ...
    float t =  iTime*0.4;
    uv.y *= 0.15;							// stretch
    float o=sin(uv.x*2110.4);				// offset
    float s=cos(uv.x*33.1)*.6 +.9;			// speed
    float trail = mix(25.0,15.0,s);			// trail length
